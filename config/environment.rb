...
Rails::Initializer.run do |config|
  ...
  config.gem 'muck-engine', :lib => 'muck_engine', :version => '>=0.1.1'
  config.gem 'muck-users', :lib => 'muck_users', :version => '>=0.1.1'
  config.gem 'muck-activity', :lib => 'muck_activity', :version => '>=0.1.1'
