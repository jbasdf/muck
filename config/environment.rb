...
Rails::Initializer.run do |config|
  ...
  config.gem "muck-raker", :lib => 'muck_raker', :version => ">=0.1.3" 
  config.gem 'muck-engine', :lib => 'muck_engine', :version => '>=0.1.6'
  config.gem 'muck-users', :lib => 'muck_users', :version => '>=0.1.6'
  config.gem 'muck-activities', :lib => 'muck_activities', :version => '>=0.1.10'
