...
Rails::Initializer.run do |config|
  ...
  config.gem 'muck-engine', :lib => 'muck_engine', :version => '>=0.2.4'
  config.gem "muck-solr", :lib => 'acts_as_solr', :version => '>=0.4.4'
  config.gem "muck-raker", :lib => 'muck_raker', :version => '>=0.1.45'
  ...
  config.gem 'muck-profiles', :lib => 'muck_profiles', :version => '>=0.1.12'
  config.gem 'muck-friends', :lib => 'muck_friends', :version => '>=0.1.12'
  config.gem 'muck-shares', :lib => 'muck_shares', :version => '>=0.1.6'
  config.gem 'muck-contents', :lib => 'muck_contents', :version => '>=0.1.6'
  config.gem 'muck-blogs', :lib => 'muck_blogs', :version => '>=0.1.6'
  config.gem 'muck-invites', :lib => 'muck_invites', :version => '>=0.1.1'
