...
Rails::Initializer.run do |config|
  ...
  config.gem 'uploader', :version => '>=0.2.0'
  config.gem 'cms-lite', :lib => 'cms_lite', :version => '>=0.5.3'
  config.gem "muck-solr", :lib => 'acts_as_solr', :version => '>=0.4.2'
  config.gem "muck-raker", :lib => 'muck_raker', :version => '>=0.1.27'
  config.gem 'muck-engine', :lib => 'muck_engine', :version => '>=0.1.31'
  config.gem 'muck-users', :lib => 'muck_users', :version => '>=0.2.11'
  config.gem 'muck-activities', :lib => 'muck_activities', :version => '>=0.1.20'
  config.gem 'muck-comments', :lib => 'muck_comments', :version => '>=0.1.10'
  config.gem 'muck-profiles', :lib => 'muck_profiles', :version => '>=0.1.10'
  config.gem 'muck-friends', :lib => 'muck_friends', :version => '>=0.1.10'
  config.gem 'muck-shares', :lib => 'muck_shares', :version => '>=0.1.4'
  config.gem 'muck-contents', :lib => 'muck_contents', :version => '>=0.1.4'
  config.gem 'muck-blogs', :lib => 'muck_blogs', :version => '>=0.1.4'
