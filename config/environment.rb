...
Rails::Initializer.run do |config|
  ...
  config.gem "muck-raker", :lib => 'muck_raker', :version => '>=0.1.39'
  config.gem 'muck-users', :lib => 'muck_users', :version => '>=0.2.13'
  ...
  config.gem 'muck-invites', :lib => 'muck_invites', :version => '>=0.1.0'
