...
require 'cucumber/formatter/unicode' # Blog out this line if you don't want Cucumber Unicode support
...
# Blog out the next line if you want Rails' own error handling
...
# Blog out the next two lines if you're not using RSpec's matchers (should / should_not) in your steps.
...
# 2. unblog Webrat.configure that contains :selenium and then blog out the one that contains :rails above
# 3. set:  self.use_transactional_fixtures = false in test_helper.rb
# 4. unblog in test_helper.rb:
      # setup do |session|
