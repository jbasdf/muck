class CreateMuckRaker < ActiveRecord::Migration
  ...
  def self.up
    ...
    create_table "cloud_cache", :force => true do |t| 
      t.integer  "language_id"
      t.string   "filter"
      t.string   "tag_list", :limit => 2500
    end
    execute "ALTER TABLE cloud_cache DROP COLUMN id, DROP PRIMARY KEY, ADD PRIMARY KEY USING BTREE(language_id, filter);"
